...
// CHANGE COMPONENT NAME AND HEADING TO SACRED/LIVING HUMAN CIRCLE
const SacredCircle = () => {
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-2xl font-semibold mb-4" style={{ color: '#C9D5DD' }}>
            A Weekly Sanctuary for Nervous System Regulation & Human Connection
          </h2>
          <p className="text-lg max-w-3xl mx-auto" style={{ color: '#BDBBBB' }}>
            Take off every mask. You’re invited as your full self, titles aside—let’s co-create sanctuary with sound, breath, and presence. True transformation begins with being seen and held, human to human.
          </p>
        </div>
